package com.jevno.safe.core.extend;
...
//			'V', 'W', 'X', 'Y', 'Z', '+', '/' };
	...
	private static final char[] PEM_ARRAY = {'M','h','A','s','j','n','4','W','F','D','S','y','k','q','E','1','8',
			'b','X','v','i','6','x','O','T','G','g','0','7','9','+','H','Y','B','J','t','N','f','K','L','2','r','P',
			'l','o','I','z','5','u','R','Z','U','p','V','a','m','e','w','c','d','C','/','Q','3'};
